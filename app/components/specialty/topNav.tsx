...
import type { StoryLoaderData } from "~/routes/story+/$storyId.$characterId";
...
export default function TopNav({
  ...
  return (
    <Flex className="fixed top-0 left-0 flex-row justify-end items-center w-full h-[50px] quadHD:h-[75px] ultraHD:h-[150px] bg-dv-990 rounded-none shadow-shadow3D px-2 flex-shrink-0 z-50">
      <Box
