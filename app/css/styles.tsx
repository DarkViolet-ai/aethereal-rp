...
export const Stories = [
  {
    ...
    author: "Mystic Scribe",
    character: [
      "Dark Violet",
      "The Whispering Elder",
      "Silent Fox",
      "Mystic Raven",
    ],
  ...
  },
  {
    ...
    author: "Celestial Storyteller",
    character: [
      "Dark Violet",
      "Orion the Lightbringer",
      "Shadow Weaver",
      "Star Whisperer",
    ],
  ...
  },
  {
    ...
    author: "Elemental Enchanter",
    character: [
      "Dark Violet",
      "Terra the Earth Guardian",
      "Zephyr the Air Spirit",
      "Blaze the Fire Lord",
